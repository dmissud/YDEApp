...
import org.yde.ydeapp.domain.out.EntityAllreadyExist;
...
public class ApplicationManagementService implements ReferenceApplicationUseCase {
    ...
    public Application referenceApplication(ReferenceApplicationCmd referenceApplicationCmd) {
        ...
        if (application != null) {
            throw new EntityAllreadyExist(String.format("Application %s all ready exist", referenceApplicationCmd.getCodeApp()));
        }
